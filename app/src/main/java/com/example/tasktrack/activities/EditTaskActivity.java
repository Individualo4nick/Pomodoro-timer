...
public class EditTaskActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        estTime.setText(String.valueOf((int) TimeUnit.SECONDS.toMinutes(editTask.getTimeEstaminated() % 3600)));
        estTimeHours.setText(String.valueOf(TimeUnit.SECONDS.toHours(editTask.getTimeEstaminated())));
